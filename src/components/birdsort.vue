                    ...
                    <div class="picture">
                        ...
                        <div class="demo-image__placeholder">
                            ...
                            <div class="block">
                                ...
                                <span class="demonstration">{{Aname}}</span>
                            </div>
                            <!--放置样本内容 -->
                            <div class="block">
                    ...
                    <div class="choose">
                        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="150px" class="demo-ruleForm">
                            ...
                            <el-form-item class="updown">
                                <el-button type="primary" @click="submitForm('ruleForm'),resetForm('ruleForm'),lastPage()" class="next" style="background-color:white;color:black;">上一张</el-button>
                                <el-button type="primary" @click="submitForm('ruleForm'),resetForm('ruleForm'),nextPage()" class="next" style="background-color:white;color:black;">下一张</el-button>  
        ...
        methods: {
            submitForm(formName) {
                ...
                if (valid) {
                    ...
                    var URL = '/api/birdLabel/v1/bird/image/info?DATANO='+this.dataNo+'&ARRESULT='+this.arresult;
                    axios.put(URL)
                            //then获取成功；response成功后的返回值（对象）
                    .then(response=>{                        
            ...
            page(){
                var url = '/api/birdLabel/v1/bird/image/info/list/pages?pageNum='+this.N+'&pageSize='+this.S;
                axios.post(url)
                        //then获取成功；response成功后的返回值（对象）
                .then(response=>{
                    console.log(response);
